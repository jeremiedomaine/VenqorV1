      ...
      {productMode === "full" && (
        ...
        >
          <span className="min-w-0 flex-1 text-slate-600">
            <span className="font-medium text-slate-900">Aperçu module Caution</span>
            {" — "}
            Le client « caution only » ne verra que cet espace. Retour au tableau
            de bord Venqor complet.
          </span>
